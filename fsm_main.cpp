...
int main(){
    FSM mach;
    string test1 = "110";                       // 6 remainder 0
    string test2 = "1010";                      // 10 remainder 1
    string test3 = "100000";                    // 32 remainder 2
    string test4 = "111111";                    // 63 remainder 0
    string test5 = "910101";                    // test invalid input
    string test6 = "101012";                    // test invalid input
    string test7 = "1010101010101111000111";    // 2796487 remainder 1
